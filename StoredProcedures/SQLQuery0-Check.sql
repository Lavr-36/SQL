...
--DELETE FROM Schedule WHERE discipline=(SELECT discipline_id FROM Disciplines	WHERE discipline_name LIKE N'Ñåòåâîå%');
...
--EXEC sp_InsertScheduleStacionar N'PV_521', N'Ñèñòåìíîå%', N'Олег', DEFAULT;
