...
(
    [group] INT CONSTRAINT FK_HM_Groups FOREIGN KEY REFERENCES Groups(group_id),
    lesson BIGINT CONSTRAINT FK_MH_Schedule FOREIGN KEY REFERENCES Schedule(lesson_id),
    [data] VARBINARY(MAX),
